...
#define PWM_DEFAULT_MODE 0
#define PWM_HUE_MODE (PERIOD_MS / 2 * 1000 / PWM_TIME_BETWEEN_HANDLERS_US) //52
#define PWM_SATURATION_MODE (PERIOD_MS * 1000 / PWM_TIME_BETWEEN_HANDLERS_US) //104
#define PWM_VALUE_MODE 1200
